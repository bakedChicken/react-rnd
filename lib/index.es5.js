...
var Rnd = /** @class */ (function (_super) {
    ...
    Rnd.prototype.render = function () {
        ...
        return (React.createElement(Draggable, { ref: function (c) {
            ...
            }, handle: dragHandleClassName ? "." + dragHandleClassName : undefined, defaultPosition: defaultValue, onMouseDown: onMouseDown, 
            // @ts-ignore
            onStart: this.onDragStart, 
            // @ts-ignore
            onDrag: this.onDrag, 
            // @ts-ignore
            onStop: this.onDragStop, axis: dragAxis, disabled: disableDragging, grid: dragGrid, bounds: bounds ? this.state.bounds : undefined, position: draggablePosition, enableUserSelectHack: enableUserSelectHack, cancel: cancel },
